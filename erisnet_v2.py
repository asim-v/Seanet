"""
   Author: Javier Emilio Bazán Sánchez
   Email: emiliobot@hotmail.com
   Fecha: 01/02/2020
   El conjunto de datos incluyó 14 atributos diferentes y 4.515 instancias, de las cuales 2.306 correspondieron 
   a la presencia de Sargazo y 2209 sin. El conjunto de datos se construyó con los datos de píxeles de cada banda
   MODIS para diferentes fechas.
...
def main(filename):
    ...
    # Evalua la red neuronal entrenada
    metrics = model.evaluate(testD, testT, verbose=0)

    # Guarda modelo
    model.save(filename)

    # Muestra las estadísticas del proceso de entrenamiento
    ...
    # Guarda la información de entrenamiento
